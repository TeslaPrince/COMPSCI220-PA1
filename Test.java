...
class Test {
	...
	private static void testStack() {
		...
		for (int i = 1; i <= 2; i++) {
			System.out.println("Stack before push: " + stack + "; Size = " + stack.size());
			char m = (char) ('A' + i * 7);
			System.out.println("Push " + m);
			stack.push(m);
			System.out.println("Stack after push: " + stack + "; Size = " + stack.size());
			System.out.println("***");
		}
		for (int i = 1; i <= 2; i++) {
			System.out.println("Stack before pop: " + stack + "; Size = " + stack.size());
			System.out.println("Popped " + stack.pop());

			System.out.println("Stack after pop: " + stack + "; Size = " + stack.size());
			System.out.println("***");
		}
		for (int i = 0; i <= 3; i++) {
			System.out.println("Stack before push: " + stack + "; Size = " + stack.size());
		...
		System.out.println("Stack before peek: " + stack + "; Size = " + stack.size());

		System.out.println("Peeked " + stack.peek());

		System.out.println("Stack after peek: " + stack + "; Size = " + stack.size());
		System.out.println("***");
		stack.push((char) 67);
		System.out.println("\n***");
		for (int i = 1; i <= 4; i++)
